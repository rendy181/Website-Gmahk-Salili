...
export const Navbar: React.FC<NavbarProps> = ({ onOpenAdmin, isAdminLoggedIn }) => {
  ...
  const navLinks = [
    ...
    { label: 'Buku-Buku', href: '/buku', icon: BookOpen }, // ← MENU BARU!
  ...
  // Jika href adalah link halaman (bukan #), biarkan navigasi normal
  if (href.startsWith('/') && !href.startsWith('#')) {
    // Biarkan link berfungsi normal (tidak di-prevent)
    return;
  }
